...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtOTP = findViewById(R.id.textView3);
        verifyOTPBtn = findViewById(R.id.ButtonaddToCom);
        generateOTPBtn = findViewById(R.id.button2);
        edtOTP.setVisibility(View.GONE);
        verifyOTPBtn.setVisibility(View.GONE);
        HomeVerAdapter = new HomeVerAdapter(this, "test");
        ...
        generateOTPBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(edtPhone.getText().toString())) {
                    ...
                    String phone = "+216" + edtPhone.getText().toString();
